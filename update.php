...
$DataUser = GetdataUser($id, $trangthai = 1);
if (empty($DataUser)) {
    header("location: index.php");
}
if (isset($_POST['change_submit'])) {
    ...
    if (empty($_POST['password'])) {
        $passwordErr = "do not password  ";
    } else {
        $password = md5($_POST['password']);
    }
    UpdateData($username, $password, $membercode, $status, $DataUser[0]['id']);
...
<div class=" content">
                        <div class="update">
                            <div class="Edit">
                                <!-- Edit Form Container -->
                                <form method="post" action="user=<?php echo $DataUser[0]['id']; ?>"">
                <!-- action use php self -->
                <h1>update information</h1>
                <div class=" code-input">
                                    <p>User Name</p>
                                    <input type="text" name="username" placeholder="enter user name " value="<?php echo $DataUser[0]['tentaikhoan']; ?>" id="">
                            </div>
                            <div class="errortext">
                                <?php echo $nameErr; ?>
                            </div>
                            <div class="code-input">
                                <p>employee code</p>
                                <input type="text" name="membership_code" placeholder="enter employee code " value="<?php echo $DataUser[0]['manhanvien']; ?>" id="">
                            </div>
                            <div class="errortext">
                            ...
                            <div class="code-input">
                                <p>Password</p>
                                <input type="text" name="password" value="<?php echo $DataUser[0]['matkhau']; ?>" id="">
                            </div>
                            <div class="errortext">
                            ...
                            <div class="code-input">
                                <p>status</p>
                                <input type="text" name="status" value="<?php echo $DataUser[0]['trangthai'] ?>" id="">
                            </div>
                            <div class="errortext">
